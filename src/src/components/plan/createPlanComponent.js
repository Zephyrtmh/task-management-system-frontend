    ...
    <>
      <div className="container mx-auto mt-5">
        ...
        <form onSubmit={onSubmit}>
          <div class="mb-6">
            <label for="planName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              Plan name
            </label>
            <input
              type="text"
              ...
              placeholder="Plan name (No special charcters)"
              required
            />
          </div>
          <div className="mb-6 grid lg:grid-cols-3 gap-4 grid-cols-1">
            <div>
              <label for="startdate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Plan start date
              </label>
              <input
                type="date"
            ...
            <div>
              <label for="enddate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Plan end date
              </label>
              <input
                type="date"
